...
public class DemoDataGenerator implements ModelDataJsonConstants {
    ...
    protected void initDemoUsers() {
        createUser("user1", "user1", "user1", "user1", "user1@activiti.org",
        ...
        createUser("user2", "user2", "user2", "user2", "user2@activiti.org",
                "org/activiti/explorer/images/kermit.jpg",
                Arrays.asList("management", "sales", "marketing", "user"),
                null);
        createUser("user3", "user3", "user3", "user3", "user3@activiti.org",
                "org/activiti/explorer/images/kermit.jpg",
                Arrays.asList("marketing", "engineering", "user"),
                null);
        createUser("user4", "user4", "user4", "user4", "user4@activiti.org",
                null,
                Arrays.asList("sales", "engineering", "user"),
                null);
        createUser("user5", "user5", "user5", "user5", "user5@activiti.org",
                null,
