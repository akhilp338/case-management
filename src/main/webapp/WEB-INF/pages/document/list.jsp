...
<body>
    ...
    -->
			...
			<div class="sidebar-wrapper">
				<ul class="nav">
					<li><a href="${pageContext.request.contextPath}/index.htm"> <i class="material-icons">dashboard</i>
							<p>Dashboard</p>
					</a></li>
					<li><a
														...
														<tr>
															<c:choose>
																<c:when test="${doc.docType eq 'BOOK_REPORT'}">
																	<td><a
																		href="${pageContext.request.contextPath}/document/caseReport/view.htm?id=${doc.id}">${doc.title}</a></td>
																</c:when>
																<c:when test="${doc.docType eq 'INVOICE'}">
																	<td><a
																		href="${pageContext.request.contextPath}/document/invoice/view.htm?id=${doc.id}">${doc.title}</a></td>
																</c:when>
																<c:otherwise>
																	<td>UNKNOWN</td>
																</c:otherwise>
