...
<div class="container">
    <div class="start-template">
        <ol class="breadcrumb">
            ...
            <li><a href="${pageContext.request.contextPath}/document/list.htm">Case</a></li>
    ...
    <div id="currentDoc" class="panel panel-default">
        <div class="panel-heading">
            ...
            <h3 class="panel-title"><strong>Case Report - ${document.title}</strong></h3>
        </div>
        <div class="panel-body">
            ...
            <form:form cssStyle="margin: 20px" cssClass="form-horizontal" method="POST" commandName="document">
                ...
                <div class="form-group">
                    <label for="bookTitle" class="col-sm-2 control-label">Case Title</label>
                ...
                <div class="form-group" style="display: none;">
                    <label for="docType" class="col-sm-2 control-label">Case Type</label>
