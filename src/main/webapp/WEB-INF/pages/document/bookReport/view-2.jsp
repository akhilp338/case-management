...
<title>Case Report View View</title>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				...
				<h3 class="panel-title">
					<strong>Case Report - ${document.title}</strong>
				</h3>
			</div>
					...
					<div class="row">
						<div class="col-sm-4">
							...
							<div class="form-group" style="display: none;">
								...
								<div class="col-sm-10">
									<form:input path="groupId" id="groupId" cssClass="form-control"
										readonly="true" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:textarea cssClass="form-control" id="content"
										path="content" rows="6" readonly="true" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<form:textarea cssClass="form-control" id="summary"
										path="summary" rows="3" readonly="true" />
								</div>
							</div>
							<div class="form-group">
