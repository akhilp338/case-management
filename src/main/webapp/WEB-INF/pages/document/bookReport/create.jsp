							...
							<div class="card">
								...
								<div class="card-content">
									...
									<form:form cssStyle="margin: 20px" cssClass="form-horizontal"
										...
										action="${pageContext.request.contextPath}/document/caseReport">
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<form:select path="groupId" cssClass="form-control"
													id="groupId" autofocus="true">
													<c:forEach var="group" items="${groups}">
														<form:option value="engineering" label="Complaince" />
													</c:forEach>
												</form:select>
											</div>
										</div>
										...
										<div class="form-group">
											<label for="bookAuthor" class="col-sm-2 control-label">Created
												By</label>
											<div class="col-sm-10">
										...
										<div class="pull-right">
											<button type="submit" class="btn btn-primary btn-default">Create Case Report</button>
