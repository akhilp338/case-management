...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation"
	style="background-color: #FF6200; color: white !important;">
	<div class="container">
		<div class="navbar-header active">
			<button type="button" class="navbar-toggle" data-toggle="collapse"
				data-target=".navbar-collapse">
				<span class="sr-only">Toggle navigation</span> <span
					class="icon-bar">hello</span> <span class="icon-bar"></span> <span
					class="icon-bar"></span>
			</button>
			<a class="navbar-brand"
				href="${pageContext.request.contextPath}/index.htm">Case
				Management</a>
		</div>
		<div class="navbar-collapse collapse"
			style="color: white !important; text-transform: uppercase;">
			<ul class="nav navbar-nav">
				<li id="nav-tasks"><a
					href="${pageContext.request.contextPath}/alert-page.htm">Alerts</a></li>
				<li id="nav-docs"><a
					href="${pageContext.request.contextPath}/document/list.htm">Case</a></li>
				<li id="nav-tasks"><a
					href="${pageContext.request.contextPath}/tasks.htm">Tasks</a></li>
				<li id="nav-workflows"><a
					href="${pageContext.request.contextPath}/workflow/index.htm">Workflows</a></li>
				<li id="nav-users"><a
					href="${pageContext.request.contextPath}/users.htm">Users</a></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown" id="nav-alerts"><a class="dropdown-toggle"
					...
					href="${pageContext.request.contextPath}/alerts.htm"> <c:choose>
						...
						</c:choose> <span id="alertCount" class="badge">${fn:length(alerts)}</span><b
						class="caret"></b></a>
						...
						<c:choose>
							<c:when test="${empty alerts}">
								<li class="list-group-item">
									<div class="alert alert-info alert-dropdown-div">You have
										no alerts</div>
								</li>
							</c:when>
							<c:when test="${not empty alerts}">
				...
				<li class="dropdown"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown">${pageContext.request.remoteUser}<b
						class="caret"></b></a>
